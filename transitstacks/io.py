...
def read_stack_from_dir(directory: str, filter_dict: Mapping[str,Any] = {}) -> Mapping[str,pd.DataFrame]:
...
def example_dir(example_name:str):
    ...
    if not os.path.exists(example_dir):
        available_examples = [name for name in os.listdir(example_dir) if os.path.isdir(name)]
